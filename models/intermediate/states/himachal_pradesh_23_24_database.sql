...
{{
    flatten_json(
        model_names = [
                        source('source_lahi', 'himachal_pradesh_23_24_database'), 
                ],
...
SELECT
    ...
    "Year_of_Approval_under_SHI" AS "year_approval_shi",
    ...
    "9Girls" AS "girls_9",
    "VC_Name" AS "vc_name",
    "Year_of_Approval" AS "year_approval",
    ...
    "Year_of_Implementation" AS "year_implementation",
    ...
    "11Girls" AS "girls_11",
    "Year_of_Approval_under_PM_Shri" AS "year_approval_pm_shri",
...
-- _Single_Double_Triple" AS "school_sector_type_single_double_triple",
    ...
    "Year_of_Approval_under_Hub_Spoke" AS "year_approval_hub_spoke"
FROM mycte
