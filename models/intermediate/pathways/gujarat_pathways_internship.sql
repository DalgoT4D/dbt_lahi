...
,_airbyte_data::json->>'Hours Per Day
 (Internship Progress form)' as "hours_per_day___internship_progress_form"
...
,_airbyte_data::json->>'Employer-Student_Ratio' as "employer_student_ratio"
...
FROM {{source('source_lahi','gujarat_pathways_internship')}}
